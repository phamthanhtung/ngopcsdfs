...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __( 'No Repeat', 'funky_theme' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'funky_theme' ),
		'repeat-y'  => __( 'Repeat Vertically', 'funky_theme' ),
		'repeat'    => __( 'Repeat All', 'funky_theme' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'funky_theme' ),
		'top center'    => __( 'Top Center', 'funky_theme' ),
		'top right'     => __( 'Top Right', 'funky_theme' ),
		'center left'   => __( 'Middle Left', 'funky_theme' ),
		'center center' => __( 'Middle Center', 'funky_theme' ),
		'center right'  => __( 'Middle Right', 'funky_theme' ),
		'bottom left'   => __( 'Bottom Left', 'funky_theme' ),
		'bottom center' => __( 'Bottom Center', 'funky_theme' ),
		'bottom right'  => __( 'Bottom Right', 'funky_theme')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'funky_theme' ),
		'fixed'  => __( 'Fixed in Place', 'funky_theme')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'funky_theme' ),
		'italic'      => __( 'Italic', 'funky_theme' ),
		'bold'        => __( 'Bold', 'funky_theme' ),
		'bold italic' => __( 'Bold Italic', 'funky_theme' )
		);
